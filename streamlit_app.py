...
from apps import home, heatmap, upload, vector, populations, worldbank, urbangreen  # import your app modules here
...
apps = [
    ...
    {"func": urbangreen.app, "title": "Population Stats", "icon": "globe"}
]
